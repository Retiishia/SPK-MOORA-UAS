...
<head>
  ...
  <title>SPK - SMK UT PGII BANDUNG</title>

  <!-- Favicons -->
  <link href="img/favicon1.png" rel="icon">
  <link href="img/apple-touch-icon" rel="apple-touch-icon">
  ...
  <section id="container">
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        ?>
        <ul class="sidebar-menu" id="nav-accordion">
          <p class="centered"><a href="index.php?module=home"><img src="img/profileanime.jpg" class="img-circle" width="80"></a></p>
          <h5 class="centered">Leticia Admin</h5>
          <li class="mt">
            <a class="" href="index.php?module=home">
              <i class="fa fa-home"></i>
              <span>Home</span>
        ...
        <div class="row">
          <div class="col-lg-12 main-chart" style="padding-left: 50px;padding-right: 50px;">
            ...
            <div class="border-head">
              <h3>BEASISWA SMK UT PGII BANDUNG</h3>
            </div>
            <?php
    ...
    <footer class="site-footer" style="margin-top: 40vh;">
      <div class="text-center">
        <p>
          &copy; Copyrights <strong>SMK UT PGII BANDUNG</strong>. All Rights Reserved
        </p>
        <div class="credits">
          <!--
          ...
          -->
          Distributed by <a href="https://facebook.com/leticiadzz" target="_blank">Farhan Aziz</a>
        </div>
